...
UL_SYMBOL void ul_hst_init(ul_hst_t * hst);
UL_SYMBOL void ul_hst_cleanup(ul_hst_t * hst);

UL_SYMBOL ul_hs_t * ul_hst_add(ul_hst_t * hst, size_t str_size, const wchar_t * str, ul_hs_hash_t str_hash);
