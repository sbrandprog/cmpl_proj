...
#define IRA_INST(name, compl_, intrp_, opd0, opd1, opd2, opd3, opd4, opd5, mods_ctl_flow_) [IraInst##name] = {              \
    .type_str = UL_ROS_MAKE(L"Inst" L## #name),                                                                             \
    .intrp_comp = intrp_,                                                                                                   \
    .compl_comp = compl_,                                                                                                   \
    .opds = { IraInstOpd##opd0, IraInstOpd##opd1, IraInstOpd##opd2, IraInstOpd##opd3, IraInstOpd##opd4, IraInstOpd##opd5 }, \
    .mods_ctl_flow = mods_ctl_flow_                                                                                         \
},
