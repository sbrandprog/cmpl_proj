...
const lnk_sect_desc_t mc_defs_sds[McDefsSd_Count] = {
	...
	[McDefsSdRdata_ItDir] = { .name = SECT_RDATA_NAME, .ord_ind = 2, .data_align = 16, .data_align_byte = 0x00, .mem_r = true },
	[McDefsSdRdata_ItHnt] = { .name = SECT_RDATA_NAME, .ord_ind = 3, .data_align = 16, .data_align_byte = 0x00, .mem_r = true },
