...
static void fill_pel() {
	...
	lnk_sect_lp_t text_sect_lps[] = {
		...
		{ .type = LnkSectLpFixup, .stype = LnkSectLpFixupRel8, .label_name = UL_HST_HASHADD_WS(&ctx.hst, L"GetStdHandle"), .off = 0xB },
		{ .type = LnkSectLpFixup, .stype = LnkSectLpFixupRel8, .label_name = UL_HST_HASHADD_WS(&ctx.hst, L"WriteFile"), .off = 0x32 },
		{ .type = LnkSectLpFixup, .stype = LnkSectLpFixupRel32, .label_name = UL_HST_HASHADD_WS(&ctx.hst, L"Sleepa"), .off = 0x3D },
