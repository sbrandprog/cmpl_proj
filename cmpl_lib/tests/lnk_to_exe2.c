...
static bool test_proc(test_ctx_t * ctx)
{
    ...
    lnk_sect_lp_t text_sect_lps[] = {
        ...
        { .type = LnkSectLpFixup, .stype = LnkSectLpFixupRel32, .label_name = UL_HST_HASHADD_WS(&ctx->hst, "GetStdHandle"), .off = 0xB },
        { .type = LnkSectLpFixup, .stype = LnkSectLpFixupRel32, .label_name = UL_HST_HASHADD_WS(&ctx->hst, "WriteFile"), .off = 0x32 },
        { .type = LnkSectLpFixup, .stype = LnkSectLpFixupRel32, .label_name = UL_HST_HASHADD_WS(&ctx->hst, "Sleep"), .off = 0x3D },
    ...
    lnk_sect_lp_t reloc_sect_lps[] = {
        ...
        { .type = LnkSectLpFixup, .stype = LnkSectLpFixupRva32, .label_name = UL_HST_HASHADD_WS(&ctx->hst, ".text#p0"), .off = 0 },
