...
const ira_inst_info_t ira_inst_infos[IraInst_Count] = {
	[IraInstNone] = { .type_str = UL_ROS_MAKE(L"InstNone"), .intrp_comp = true, .compl_comp = true, .opds = { IraInstOpdNone, IraInstOpdNone, IraInstOpdNone, IraInstOpdNone, IraInstOpdNone } },
#define IRA_INST(name, compl_, intrp_, opd0, opd1, opd2, opd3, opd4) [IraInst##name] = { .type_str = UL_ROS_MAKE(L"Inst" L ## #name), .intrp_comp = intrp_, .compl_comp = compl_, .opds = { IraInstOpd##opd0, IraInstOpd##opd1, IraInstOpd##opd2, IraInstOpd##opd3, IraInstOpd##opd4 } },
